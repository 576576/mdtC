...
5.控制输出
分为4种,范围:
{enable shoot config color}

enabled,config,color接受1参数
shoot链式连接to
to只会链式连接在shoot后,接受1参数时为shootp
...
uradar enemy ground any distance 0 0 result
